...
function peg$parse(input, options) {
  ...
  var peg$e0 = peg$classExpectation(["\t", "\v", "\n", "\r", "\f", " "], false, false);
  ...
  var peg$e16 = peg$classExpectation(["e", "E"], false, false);
  var peg$e17 = peg$classExpectation(["-", "+"], false, false);

  var peg$f0 = function(first, a) {return a;};
  var peg$f1 = function(first, rest) {
    rest.unshift(first);
    return rest;
};
  var peg$f2 = function(first) {
    return [first];
};
  ...
  var peg$f9 = function(start, parts) {
    return new ast.SExpSymbol(start + parts.join(""));
};
  var peg$f10 = function(parts) { return ast.SExpNumber.floatVal(parts); };
  var peg$f11 = function(parts) { return ast.SExpNumber.floatVal(parts); };
  var peg$f12 = function(parts) { return ast.SExpNumber.intVal(parts); };
  var peg$currPos = 0;
  var peg$savedPos = 0;
